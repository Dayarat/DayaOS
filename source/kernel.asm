...
[SEGMENT .data]
	strWelcomeMsg		db	"--------------------Welcome to DayaOS--------------------", 0x00

	wel1 db	'///////////////////////////////////////////', 0x00			

	wel2 db '//////////// WELCOME TO DayaOS ////////////', 0x00 
	...
	wel7 db ' DayaOS version 0.1.0', 0x00
	...
	h_ver db ' Type ver for OS version', 0x00
	h_info db ' Type info for Hardware infomation', 0x00
	h_help db ' Type help for Help', 0x00
	h_exit db ' Type exit for Exit', 0x00


	strPrompt		db	"DayaOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"DayaOS", 0x00	;OS details
	strMajorVer		db	"0", 0x00
	strMinorVer		db	".1.0", 0x00
	...
	txtVersion		db	"ver", 0x00	;messages and other strings
